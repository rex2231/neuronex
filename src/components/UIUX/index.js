      ...
      <div className="bg-image">
        <div className="container">
          <div>
            ...
            <div className="timing">(10.00 am to 12.30 pm)</div>
          </div>
            ...
            <div className="page-container">
              <div className="description-container">
                ...
                <p className="description-element">
                  In the UI and UX design workshop, participants delve into
                  crafting visually appealing interfaces (UI) and optimizing
                  user experiences (UX). Through hands-on exercises, they learn
                  design principles, usability techniques, and collaboration
                  strategies. The workshop fosters practical skills, empowering
                  attendees to create engaging digital solutions that prioritize
                  both aesthetics and user satisfaction.
                </p>
              </div>
              <div className="rules-container">
                ...
                <ul className="rules-list">
                  ...
                  <li className="list-item">
                    ● Bring your laptops in fully charged condition and with
                    internet connection.
                  </li>
