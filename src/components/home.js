...
function Home() {
    ...
    return (
        ...
        <Wrapper>
            ...
            <Content>
                <Section title="BUG BASH CHALLENGE" slogan="Our code, your solution" desc="It consists of three levels starting from Quiz where certain Questions will be asked followed by debugging includes fixing errors and finally DSA,which involves organising,manipulating data efficient and designing algorithms to solve problems.In Quiz four option will be provided and you must identify the correct option out of it.In DSA round all kinds of problems will be asked.In debugging round certain set of codes will be given and you have to find out the errors." link="/bug-bash-challenge" regLink="https://docs.google.com/forms/d/e/1FAIpQLScxgCmKPe6EtGGv6lIZODUsNPmnL3K52cUDLRGEHaxgLD9S0w/viewform" leftbtn="CUSTOM ORDER" rightbtn="EXISTING INVENTORY" backgroundImg="bug.png"/>
            </Content>
            <Content>
            ...
            <Content>
                <Section title="CODE SPRINT SHUTDOWN" slogan="Hack the impossible" desc="Build,Break ,innovate join the 'codesprint showdown' revolution,Gear up,hacker!,The coding marathon is on ,level up your skills,design for good win big,launch your ideas." link="/code-sprint-shutdown" regLink="https://docs.google.com/forms/d/e/1FAIpQLScxgCmKPe6EtGGv6lIZODUsNPmnL3K52cUDLRGEHaxgLD9S0w/viewform" leftbtn="ORDER NOW" rightbtn="LEARN MORE" backgroundImg="coding.png"/>
            </Content>
            <Content>
